...
import tfg.cristian.project.domain.NinjaBubbleGame
import tfg.cristian.project.domain.GameSettings
import tfg.cristian.project.domain.GameStatus
import tfg.cristian.project.domain.MoveDirection
import tfg.cristian.project.domain.Weapon
import tfg.cristian.project.domain.audio.AudioPlayer
import tfg.cristian.project.domain.levels
import tfg.cristian.project.domain.target.EasyTarget
import tfg.cristian.project.domain.target.MediumTarget
import tfg.cristian.project.domain.target.StrongTarget
import tfg.cristian.project.domain.target.Target
import tfg.cristian.project.util.detectMoveGesture
...
import me.sample.library.resources.kunai
import me.sample.library.resources.ninjabkg
import me.sample.library.resources.run_sprite
import me.sample.library.resources.standing_ninja
...
@Composable
fun NinjaBubbleScreen(navController: NavHostController) {
    val scope = rememberCoroutineScope()
    val audio = koinInject<AudioPlayer>()
    var game by remember { mutableStateOf(NinjaBubbleGame()) }
    ...
    Box(
        ...
        Image(
            ...
            painter = painterResource(Res.drawable.ninjabkg),
