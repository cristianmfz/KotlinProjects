package com.web.composehtml_js.util
...
object Res {
    ...
    object String {
        const val NAME = "Cristian Martínez"
        const val PROFESSION = "Kotlin Multiplaform Developer"
        const val ABOUT_ME = "Lorem ipsum dolor sit amet, nisl tempus lorem adipiscing elit. Donec sollicitudin blandit tellus, ac sagittis ligula egestas consequat. Lorem ipsum dolor sit amet."
        const val BUTTON_TEXT = "Get in touch"
        const val ROBOTO_CONDENSED = "RobotoCondensedBold"
        const val ROBOTO_REGULAR = "RobotoRegular"
        const val MY_EMAIL = "mailto:cristian.martinez@gmail.com"
