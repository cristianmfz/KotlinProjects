...
import com.multiplatform.flappybee.util.Platform
...
data class Game(
    ...
    val gravity: Float = when (platform) {
        Platform.Android, Platform.iOS -> 0.8f
        Platform.Web -> 0.25f
        Platform.Desktop -> 0.02f
    },
    val beeRadius: Float = 30f,
    val beeJumpImpulse: Float = when (platform) {
        Platform.Android, Platform.iOS -> -14f
        Platform.Web -> -8f
        Platform.Desktop -> -2f
    },
    val beeMaxVelocity: Float = when (platform) {
        Platform.Android -> 25f
        Platform.iOS -> 20f
        Platform.Web -> 20f
        Platform.Desktop -> 10f
    },
    val pipeWidth: Float = 150f,
    val pipeVelocity: Float = when (platform) {
        Platform.Android -> 5.5f
        Platform.iOS -> 7f
        Platform.Web -> 3f
        Platform.Desktop -> 0.7f
    },
    val pipeGapSize: Float = when (platform) {
        Platform.Android -> 250f
        else -> 300f
    }
) : KoinComponent {
